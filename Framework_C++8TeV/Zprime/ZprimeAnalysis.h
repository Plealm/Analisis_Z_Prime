...
class ZprimeAnalysis : public TSelector {
  public :
  ...
  ZprimeAnalysis(TTree * =0) : fChain(0) { }
  ...
  ClassDef(ZprimeAnalysis,0);
};

#endif

#ifdef ZprimeAnalysis_cxx
void ZprimeAnalysis::Init(TTree *tree)
{
...
#endif // #ifdef ZprimeAnalysis_cxx
