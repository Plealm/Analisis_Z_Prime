...
// Methods
////////////////////////////////////////////////////////////////////////////////
void ZprimeAnalysis::define_histograms()
{
  // HISTOGRAMS
  // Global histograms
  ...
  hist_mzp          = new TH1F("hist_mzp",         "Transverse Mass; M^{Z'}_{T};Events", 40, 0, 3500);
  hist_m2jets       = new TH1F("hist_m2jets",      "Invariant Mass Two Leading Jets; M^{2jets}_{T};Events", 40, 0, 3500);
  hist_m3jets       = new TH1F("hist_m3jets",      "Invariant Mass Three Leading Jets; M^{3jets}_{T};Events", 40, 0, 3500);
...
////////////////////////////////////////////////////////////////////////////////
void ZprimeAnalysis::FillOutputList()
{
  // histograms
  ...
  GetOutputList()->Add(hist_mzp);
  GetOutputList()->Add(hist_m2jets);
  GetOutputList()->Add(hist_m3jets);
...
////////////////////////////////////////////////////////////////////////////////
void ZprimeAnalysis::WriteHistograms()
{
  // histograms
...
void ZprimeAnalysis::FillHistogramsGlobal( double m, float w , TString s)
{
  ...
  if (s.Contains("hist_mzp")) hist_mzp->Fill(m,w);

  if (s.Contains("hist_m2jets")) hist_m2jets->Fill(m,w);

  if (s.Contains("hist_m3jets")) hist_m3jets->Fill(m,w);

}

void ZprimeAnalysis::FillHistogramsLeadlept( double m, float w , TString s)
{
  //Leading lepton histograms
...
void ZprimeAnalysis::FillHistogramsLeadJet( double m, float w , TString s)
{
